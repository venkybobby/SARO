...
|---|---|---|---|
| STORY-AISEC-001 | Deterministic prompt-injection normalization + detection rule-pack | SPECIFIED | spec only — `specs/stories/STORY-AISEC-001_prompt_injection_normalization_pack.md` |
