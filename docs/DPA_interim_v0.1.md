...
**Version:** 0.1 | **Date:** 2026-05-29  
**Status:** Signable — replaces v0 for new signatories.
...
|---|---|---|---|
| 0 | 2026-05-28 | Venky (Lead) | Initial interim DPA — §8 jurisdiction left as placeholder |
| 0.1 | 2026-05-29 | Venky (Lead) | §8 jurisdiction completed: England & Wales |

> **Note:** `DPA_interim_v0.md` is retained unchanged as the immutable historical baseline.  
> New signatories should use this document (v0.1). Existing signatories on v0 should be offered an amendment to v0.1 on next renewal.
...
- SHA-256 hash-chained audit traces — evidence of record integrity for human auditor review
...
This Agreement is governed by the **law of England and Wales**. Any dispute arising out of or in connection with this Agreement shall be subject to the **exclusive jurisdiction of the courts of England and Wales**.
...
*This interim DPA covers GDPR Article 28 essentials and is designed for immediate use while the full DPA undergoes legal review. It does not cover all scenarios; customers with specific requirements (SCCs, BCRs, sector-specific obligations) should request the full DPA.*
